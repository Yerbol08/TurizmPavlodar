...
import com.example.turizmpavlodar.ui.gallery.ResttoranActivity
import com.example.turizmpavlodar.ui.home.HomeItems

class PlacesAdapter(private val list: List<HomeItems>, var context: Context): RecyclerView.Adapter<PlacesAdapter.ViewHolder>()  {
